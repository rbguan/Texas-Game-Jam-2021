...
namespace AwesomeToon
{
    /*
     ...
     Credits: SnutiHQ
     Essentially a helper script for the toon shader. What it does is that it looks
     at all the lights in the scene (+ their colors and distances) and puts them into
     the object's material so the shader can affect it.
